...
from metrics import accuracy_system, split_label
...
def parse_args():
    ...
    parser.add_argument('--type_clothes_weight', type=str, default="/content/gdrive/MyDrive/model/EffNet_B2_type_Aug/efficientnet-b2type_clothes.pt")
    parser.add_argument('--color_clothes_weight', type=str, default="/content/gdrive/MyDrive/model/EffNet_B2_color_Aug/efficientnet-b2color_clothes.pt")
