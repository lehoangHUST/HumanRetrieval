...
clothes_dataset = dataset_base.copy({
          'name': 'clothes',
          'train_info': '<path_info_train>.json',
          'train_images': '/content/image/image/',
          'valid_info': '<path_info_val>.json',
          'valid_images': '/content/validation/validation/image/',
          'class_names': ("short_sleeved_shirt",
                          "long_sleeved_shirt",    
...
yolact_base_clothes_config = yolact_base_config.copy({
    'name': 'yolact_resnet101_clothes',
...
yolact_plus_resnet101_clothes_config = yolact_plus_base_config.copy({
    'name': 'yolact_plus_resnet101_clothes',
