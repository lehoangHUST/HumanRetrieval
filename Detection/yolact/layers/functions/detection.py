...
class Detect(object):
    ...
    def yolov5_nms(self, boxes, masks, scores, iou_threshold=0.5, conf_threshold=0.5):
        """
        Recreate YOLOv5 nms to replace YOLACT traditional_nms
        """
        nc = scores.size(0)
        xc = scores > conf_threshold
